...
class PawchiveApi(
    ...
    private val account: PawchiveAccountApi,
) {
  fun hasSession(): Boolean = account.hasSession()
  ...
  suspend fun getFavorites(type: String): List<Creator> = account.favoriteCreators(type)

  suspend fun getFavoritePosts(): List<Post> = account.favoritePosts()

  suspend fun addFavoriteCreator(
      service: String,
      creatorId: String,
  ) {
    account.setCreatorFavorite(service, creatorId, favorite = true)
  }
  ...
  suspend fun removeFavoriteCreator(
    ...
    account.setCreatorFavorite(service, creatorId, favorite = false)
  }
  ...
  suspend fun addFavoritePost(
    ...
    account.setPostFavorite(service, creatorId, postId, favorite = true)
  }
  ...
  suspend fun removeFavoritePost(
    ...
    account.setPostFavorite(service, creatorId, postId, favorite = false)
  }
  ...
  suspend fun flagPost(
    ...
    account.flagPost(service, creatorId, postId)
  }

  suspend fun logout() = account.logout()
}
