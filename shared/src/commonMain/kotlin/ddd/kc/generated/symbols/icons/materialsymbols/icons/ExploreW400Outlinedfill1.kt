...
public val Icons.ExploreW400Outlinedfill1: ImageVector
  get() {
    if (_exploreW400Outlinedfill1 != null) {
      return _exploreW400Outlinedfill1!!
    }
    _exploreW400Outlinedfill1 =
        Builder(
                name = "ExploreW400Outlinedfill1",
            ...
            .apply {
              path(
                ...
                moveToRelative(300.0f, 660.0f)
                lineToRelative(280.0f, -80.0f)
                lineToRelative(80.0f, -280.0f)
                lineToRelative(-280.0f, 80.0f)
                lineToRelative(-80.0f, 280.0f)
                close()
...
private var _exploreW400Outlinedfill1: ImageVector? = null
